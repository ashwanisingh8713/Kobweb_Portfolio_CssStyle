...
//import com.varabyte.kobweb.silk.style.before
//import com.varabyte.kobweb.silk.style.hover
...
val projectCardImgBox = CssStyle {
    base {
...
val ProjectCardTextOverlay = CssStyle {
    base {
        Modifier
            .position(Position.Absolute)
            .textAlign(TextAlign.Center)
